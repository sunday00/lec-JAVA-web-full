...
public class PromotionSql {
    public static final String SELECT_ALL = "SELECT p.id as id, pd.description as title, d.place_name as address, d.opening_hours as description, f.save_file_name as thumbnail" +
            " FROM promotion p " +
