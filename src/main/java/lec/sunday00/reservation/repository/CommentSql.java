...
public class CommentSql {
    public static final String SELECT_ALL = "SELECT c.id, c.product_id, c.reservation_info_id, c.score, c.comment, f.save_file_name as image, r.reservation_name as user_name, c.create_date FROM reservation_user_comment c " +
