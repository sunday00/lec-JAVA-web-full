...
<script type="rv-template" id="itemList">
    <a href="{{event_url}}" class="item_book">
        <div class="item_preview">
            <img alt="{{event_dsc}}" class="img_thumb" src="{{event_thumbnail}}">
            <span class="img_border"></span>
        </div>
        <div class="event_txt">
            <h4 class="event_txt_tit"> <span>{{event_title}}</span> <small class="sm">{{event_adr}}</small> </h4>
            <p class="event_txt_dsc">{{event_dsc}}</p>
        </div>
    </a>
</script>
